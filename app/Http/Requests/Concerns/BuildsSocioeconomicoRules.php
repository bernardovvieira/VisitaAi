...
trait BuildsSocioeconomicoRules
{
    ...
    protected function socioeconomicoFormRules(): array
    {
        ...
        $rules = [
            ...
            'socio.viz_frente' => ['nullable', 'string', 'max:180'],
            'socio.viz_fundos' => ['nullable', 'string', 'max:180'],
            'socio.viz_direita' => ['nullable', 'string', 'max:180'],
            'socio.viz_esquerda' => ['nullable', 'string', 'max:180'],
            ...
            'socio.iptu_desde' => ['nullable', 'string', 'max:60'],
            'socio.local_data_assinatura' => ['nullable', 'string', 'max:255'],
            'socio.num_comodos' => ['nullable', 'integer', 'min:0', 'max:200'],
            'socio.num_quartos' => ['nullable', 'integer', 'min:0', 'max:100'],
            'socio.num_banheiros' => ['nullable', 'integer', 'min:0', 'max:100'],
