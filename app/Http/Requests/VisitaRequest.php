...
class VisitaRequest extends FormRequest
{
     ...
     *
     * @param  Authenticatable|null  $user  Usuário logado (para regra de atividade ACS)
     * @return array<string, array<int, string>>
     */
    public static function rulesForUser(?Authenticatable $user = null): array
    {
        ...
        return [
            ...
            'morador_obs' => ['nullable', 'array'],
            'morador_obs.*' => ['nullable', 'string', 'max:2000'],
        ];
    }
