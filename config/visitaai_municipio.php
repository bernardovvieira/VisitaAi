...
/**
 * Dados complementares municipalmente no Visita Aí (ocupantes, perfil socioeconômico do imóvel).
 *
 * Complementam o cadastro municipal de imóveis e podem ser usados com ou sem o módulo de visitas
 * de vigilância entomológica / PNCD: são finalidades distintas que o município pode integrar.
 *
...
return [
    ...
    */
    'lgpd' => [
        ...
        'resumo_sistema' => 'O Visita Aí trata dados pessoais para gestão municipal em saúde pública e cadastro de imóveis: registro de visitas de campo com possível inclusão de vigilância entomológica e controle vetorial, conforme adotado pelo município; cadastro municipal de imóveis; dados complementares de ocupantes e informações socioeconômicas; em consonância com a Constituição Federal, a Lei nº 8.080/1990 e a LGPD, com minimização, transparência e governança nos termos dos arts. 6º e 23 a 27 da LGPD.',
        ...
        'finalidades' => 'Finalidades: registro de visitas de campo e ações de vigilância em saúde, quando adotadas pelo município; cadastro municipal de imóveis; dados complementares de ocupantes e perfil socioeconômico vinculado ao imóvel para planejamento e políticas municipais; indicadores agregados. Os módulos podem ser utilizados de forma conjunta ou independente, conforme organização local, sempre com respaldo nas finalidades de saúde pública e interesse público (art. 6º, II e III, LGPD), em articulação com a Lei nº 8.080/1990.',
    ...
    'ocupantes' => [
        ...
        'painel_sensivel_gestor_titulo' => 'Dados dos ocupantes',
    ...
    */
    'indicadores' => [
        ...
        'subtitulo_completude' => 'Percentual de ocupantes com cada campo preenchido além de “Não informado” (ou com data de nascimento informada). Inclui sexo, estado civil, parentesco com o titular e renda formal/informal.',
        ...
        'botao_export_csv' => 'Exportar CSV com dados consolidados',
