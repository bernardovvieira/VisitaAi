...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <section class="p-4 bg-white dark:bg-gray-700 rounded-lg shadow">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">
            Preencha os dados da visita. Se estiver <strong>sem internet</strong>, você pode guardar a visita no dispositivo e enviar depois pela tela «Minhas visitas» → «Enviar visitas salvas no dispositivo».
        </p>
    </section>
...
<script>
    ...
    document.getElementById('btn-save-draft').addEventListener('click', function() {
        ...
        window.VisitaOfflineSaveDraft('saude', payload).then(function() {
