...
<div class="space-y-4">
    ...
    <div>
        ...
        <select id="mor_escolaridade" name="mor_escolaridade" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200">
    ...
    <div>
        ...
        <select id="mor_renda_faixa" name="mor_renda_faixa" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200">
            <option value="">{{ __('— Selecionar —') }}</option>
    ...
    <div>
        ...
        <textarea id="mor_observacao" name="mor_observacao" rows="3" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200">{{ old('mor_observacao', $morador->mor_observacao) }}</textarea>
