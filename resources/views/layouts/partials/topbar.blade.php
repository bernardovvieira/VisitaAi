...
<header class="sticky top-0 z-20 flex h-12 shrink-0 items-center justify-end gap-1 border-b border-slate-200/90 bg-white/95 px-2 backdrop-blur-md dark:border-slate-700 dark:bg-slate-900/95 sm:h-14 sm:justify-between sm:px-4">
    <div class="flex min-w-0 flex-1 items-center sm:flex-none">
        <button type="button"
                class="inline-flex items-center justify-center rounded-lg p-2 text-slate-600 hover:bg-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-2 dark:text-slate-300 dark:hover:bg-slate-800 dark:focus-visible:ring-offset-slate-900 lg:hidden"
    ...
    <div class="flex shrink-0 items-center gap-0.5 sm:gap-2">
        ...
        <x-dropdown align="right" width="w-56">
            <x-slot name="trigger">
                <button type="button"
                        class="inline-flex max-w-[min(100vw-8rem,14rem)] items-center gap-2 rounded-lg py-1.5 pl-1 pr-1.5 text-left transition hover:bg-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/30 dark:hover:bg-slate-800 sm:max-w-[16rem]">
                    <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-emerald-700 text-xs font-semibold text-white dark:bg-emerald-600"
                          aria-hidden="true">
