...
<div class="header">
    <div style="position:relative; font-size:10pt;">
        ...
        <div style="position:absolute; top:6px; right:12px; font-size:9pt; color:rgba(0,0,0,0.45); font-weight:600; font-family: DejaVu Sans, sans-serif;">Imóvel #{{ $local->loc_codigo_unico }}</div>
    </div>
</div>
