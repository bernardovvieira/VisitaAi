...
@section('og_title', config('app.brand') . ' · ' . __('Painel do :perfil', ['perfil' => \App\Helpers\MsTerminologia::perfilLabel('agente_endemias')]))
...
<div class="v-dash">
    ...
    <div class="v-dash-card" aria-labelledby="agente-atalhos-heading">
        <h2 id="agente-atalhos-heading" class="v-dash-card__title">{{ __('Ações rápidas') }}</h2>
        <div class="v-dash-shortcuts v-dash-shortcuts--tight mt-4" style="grid-template-columns: minmax(0, 1fr);">
