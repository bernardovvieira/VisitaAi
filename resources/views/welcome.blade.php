        ...
        <div class="space-y-8 md:pl-4 max-w-xl" id="anim-texto">
            <div class="space-y-4">
                <h1 class="text-4xl font-extrabold leading-tight text-gray-900 dark:text-white">
                    Bem-vindo(a) ao <span class="text-emerald-600 dark:text-emerald-400">Visita Aí</span>
                </h1>
                @if ($local)
                    <p class="text-lg font-medium text-emerald-700 dark:text-emerald-300">
            ...
            <div class="flex flex-col sm:flex-row gap-4" id="anim-botoes">
                <a href="{{ route('login') }}"
                   class="btn-acesso-principal inline-flex items-center justify-center gap-2 rounded-xl px-6 py-3 font-semibold text-white shadow-sm transition group focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900">
                ...
                <a href="{{ route('consulta.index') }}"
                   class="group inline-flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-6 py-3 font-semibold text-gray-900 shadow-sm transition hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700">
                    <svg class="h-5 w-5 transform transition-transform duration-200 group-hover:-translate-x-1" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            {{-- Conformidade MS --}}
            <div class="mt-6 rounded-xl border border-emerald-200/90 bg-emerald-50/90 px-4 py-3 dark:border-emerald-800 dark:bg-emerald-950/35" id="anim-conformidade">
                <p class="flex items-center gap-2 text-sm font-semibold text-emerald-950 dark:text-emerald-100">
                    <svg class="h-5 w-5 shrink-0 text-emerald-600 dark:text-emerald-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                    </svg>
                    Conformidade com o Ministério da Saúde
                </p>
                <p class="mt-1 text-xs leading-relaxed text-emerald-900/90 dark:text-emerald-200/90">
