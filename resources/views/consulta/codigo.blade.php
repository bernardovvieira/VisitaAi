...
<div class="max-w-4xl mx-auto space-y-10">
    ...
    <div style="padding-top: 2rem;">
        ...
        <button type="button" id="btn-baixar-card" aria-label="Baixar card com QR Code"
            class="inline-flex items-center gap-1.5 text-sm font-medium text-blue-700 dark:text-blue-400 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/35 rounded-sm">
    ...
    <section class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">{{ __('Histórico de visitas') }}</h2>
