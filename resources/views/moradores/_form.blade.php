...
<div class="space-y-4">
    ...
    <div>
        ...
        <select id="mor_escolaridade" name="mor_escolaridade" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
    ...
    <div>
        ...
        <select id="mor_renda_faixa" name="mor_renda_faixa" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            <option value="">{{ __('— Selecionar —') }}</option>
    ...
    <div>
        ...
        <textarea id="mor_observacao" name="mor_observacao" rows="3" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('mor_observacao', $morador->mor_observacao) }}</textarea>
